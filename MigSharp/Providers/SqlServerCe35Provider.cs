...
namespace MigSharp.Providers
{
    ...
    [Supports(DbType.AnsiString, MaximumSize = 4000, CanBeUsedAsPrimaryKey = true, Warning = "Is not natively supported by SQL Server CE 3.5. DbParameters with DbType.AnsiString will not work (instead use DbType.String).")]
    [Supports(DbType.AnsiString, Warning = "Is not natively supported by SQL Server CE 3.5. DbParameters with DbType.AnsiString throws an exception (instead cast the DbParameter to SqlCeParameter and set SqlDbType to SqlDbType.NText).")]
    ...
    internal class SqlServerCe35Provider : SqlServerProviderBase
    {
        public const string InvariantName = "System.Data.SqlServerCe.3.5";
